...
## 파일 구성
- `01_raw_check.sql` : 원본 데이터 행 수 및 샘플 데이터 확인
- `02_cleaning.sql` : 정제 테이블 생성
- `03_validation.sql` : 정제 후 결측치 및 행 수 검수

## 결과 화면

### 1. 원본 데이터 확인
![원본 데이터 확인](01_raw_check.png)

### 2. 결측치 점검
![결측치 점검 1](02_profiling_01.png)
![결측치 점검 2](02_profiling_02.png)
![결측치 점검 3](02_profiling_03.png)

### 3. 정제 후 검수
![정제 후 검수 1](03_validation_01.png)
![정제 후 검수 2](03_validation_02.png)
![정제 후 검수 3](03_validation_03.png)
